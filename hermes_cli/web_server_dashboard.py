...
def mount_spa(application: FastAPI):
    ...
    import hermes_cli.web_server as _web_server_mod  # live-read _SESSION_TOKEN (#96490 rotation)
        ...
        async def no_frontend(full_path: str):
            ...
            if full_path == "" and not gated:
                return HTMLResponse(
                    ...
                    f"window.__HERMES_SESSION_TOKEN__={json.dumps(_web_server_mod._SESSION_TOKEN)};"
    ...
    def _serve_index(prefix: str = ""):
        ...
        token_js = "" if gated else f'window.__HERMES_SESSION_TOKEN__="{_web_server_mod._SESSION_TOKEN}";'
        bootstrap_script = (
            f"<script>{token_js}"
